...
class CampanhasPerfil extends PureComponent {
    ...
    render() {
        ...
        const nome = this.props.navigation.getParam('nome', "Sem Nome");
        ...
        return (
            <MenuProvider>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Color.primary, height: 60, elevation: 3 }}>
                    ...
                    <View style={{flex:1}}>
                        <Text style={{ color: '#fff', fontSize: 20, fontWeight: "bold", padding: 20, paddingLeft: 10 }}> Campanhas Solicitadas Por {nome}</Text>
                        <ScrollView
                        ...
                        >
                            ...
                            <TouchableOpacity
                                ...
                                <View style={{ backgroundColor: '#fff', padding: 8, paddingBottom: 15, marginVertical: 5, marginLeft: 15, marginRight: 40, borderRadius: 12, elevation: 10 }} 
                                    ...
                                    <Text style={{ fontWeight: 'bold', fontSize: 20, paddingBottom: 5, paddingHorizontal: 5, marginRight: 30 }}>H1N1</Text>
                                    <Text style={{ color: '#000000', paddingHorizontal: 5 }}>Status: Aprovado</Text>
                                </View>
                            </TouchableOpacity> 
                            ...
                            <TouchableOpacity>
                                <View style={{ backgroundColor: '#fff', padding: 8, paddingBottom: 15, marginVertical: 5, marginLeft: 15, marginRight: 40, borderRadius: 12, elevation: 10 }} 
                                    ...
                                    <Text style={{ fontWeight: 'bold', fontSize: 20, paddingBottom: 5, paddingHorizontal: 5, marginRight: 30 }}>Sarampo</Text>
                                    <Text style={{ color: '#000000', paddingHorizontal: 5 }}>Status: Em Análise</Text>
                                </View>
                            </TouchableOpacity> 
                            ...
                            <TouchableOpacity>
                                <View style={{ backgroundColor: '#fff', padding: 8, paddingBottom: 15, marginVertical: 5, marginLeft: 15, marginRight: 40, borderRadius: 12, elevation: 10 }} 
                                    ...
                                    <Text style={{ fontWeight: 'bold', fontSize: 20, paddingBottom: 5, paddingHorizontal: 5, marginRight: 30 }}>Covid-19</Text>
                                    <Text style={{ color: '#000000', paddingHorizontal: 5 }}>Status: Reprovado</Text>
                                </View>
                            </TouchableOpacity> 
...
export default CampanhasPerfil;